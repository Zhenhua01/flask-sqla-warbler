...
class User(db.Model):
    ...
    def check_liked_message(self, message):
        """Checks if message is liked by current user"""

        liked_message_list = [
            msg for msg in self.liked_messages if msg == message]
        return liked_message_list
